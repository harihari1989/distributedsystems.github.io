...
- `pages/` contains topic pages in HTML.
- `assets/` holds CSS, JavaScript, and images.
- `scripts/` contains local datasets for interactive visuals.

## Contributing
Follow `AGENTS.md` for content and formatting rules.
